...
var _mdgriffith$style_elements$Element_Input$Range = {ctor: 'Range'};
...
var _mdgriffith$style_elements$Element_Input$text = A2(
	...
	{ctor: '[]'});
var _mdgriffith$style_elements$Element_Input$range = A2(
	_mdgriffith$style_elements$Element_Input$textHelper,
	_mdgriffith$style_elements$Element_Input$Range,
	{ctor: '[]'});
...
var _user$project$Savage_Data$Record = F5(
	function (a, b, c, d, e) {
		return {id: a, category: b, title: c, firstChapter: d, entries: e};
	});
var _user$project$Savage_Data$Entry = F4(
	function (a, b, c, d) {
		return {id: a, chapter: b, text: c, summary: d};
	});
var _user$project$Savage_Data$emptyEntry = A4(_user$project$Savage_Data$Entry, 0, 0, 'no entry', _elm_lang$core$Maybe$Nothing);
var _user$project$Savage_Data$entryDecoder = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Savage_Data$Entry)))));
var _user$project$Savage_Data$JsonRoot = F2(
	function (a, b) {
		return {records: a, maxChapter: b};
	});
var _user$project$Savage_Data$Invalid = {ctor: 'Invalid'};
var _user$project$Savage_Data$emptyRecord = A5(
	_user$project$Savage_Data$Record,
	0,
	_user$project$Savage_Data$Invalid,
	'no record',
	1,
	{ctor: '[]'});
var _user$project$Savage_Data$World = {ctor: 'World'};
var _user$project$Savage_Data$Power = {ctor: 'Power'};
var _user$project$Savage_Data$Character = {ctor: 'Character'};
var _user$project$Savage_Data$categoryDecoder = function (s) {
	var s_ = _elm_lang$core$String$toLower(s);
	var category = function () {
		var _p0 = s_;
		switch (_p0) {
			case 'character':
				return _user$project$Savage_Data$Character;
			case 'power':
				return _user$project$Savage_Data$Power;
			case 'world':
				return _user$project$Savage_Data$World;
			default:
				return _user$project$Savage_Data$Invalid;
		}
	}();
	return _elm_lang$core$Json_Decode$succeed(category);
};
var _user$project$Savage_Data$recordDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'entries',
	_elm_lang$core$Json_Decode$list(_user$project$Savage_Data$entryDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'firstChapter',
		_elm_lang$core$Json_Decode$int,
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'category',
				A2(_elm_lang$core$Json_Decode$andThen, _user$project$Savage_Data$categoryDecoder, _elm_lang$core$Json_Decode$string),
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'id',
					_elm_lang$core$Json_Decode$int,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Savage_Data$Record))))));
var _user$project$Savage_Data$dataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'maxChapter',
	_elm_lang$core$Json_Decode$int,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'records',
		_elm_lang$core$Json_Decode$list(_user$project$Savage_Data$recordDecoder),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Savage_Data$JsonRoot)));

var _user$project$Main$filterRecords = F2(
	function (filters, records) {
		return A3(
			...
			A2(_elm_lang$core$Maybe$withDefault, '', filters.text),
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return _elm_lang$core$Native_Utils.cmp(r.firstChapter, filters.limitChapter) < 1;
				},
				A2(
					_elm_lang$core$List$filter,
					function (r) {
						return _elm_lang$core$Native_Utils.eq(r.category, filters.category);
					},
					records)));
	});
		...
		switch (_p2.ctor) {
			case 'NoOp':
				return A2(
					...
					_p9,
					{ctor: '[]'});
			case 'FetchDataCompleted':
				var _p3 = _p2._0;
				if (_p3.ctor === 'Ok') {
					var _p4 = _p3._0.records;
					var filters_ = _elm_lang$core$Native_Utils.update(
						_p8,
						{maxChapter: _p3._0.maxChapter});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							_p9,
							{
								allRecords: _p4,
								displayRecords: A2(_user$project$Main$filterRecords, _p8, _p4),
								filters: filters_
							}),
						{ctor: '[]'});
				} else {
					if (_p3._0.ctor === 'BadPayload') {
						var _p5 = A2(_elm_lang$core$Debug$log, _p3._0._0, 'error');
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_p9,
							{ctor: '[]'});
			...
			case 'UpdateChapter':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							filters: filters_,
							displayRecords: A2(_user$project$Main$filterRecords, filters_, _p9.allRecords)
						}),
					{ctor: '[]'});
			case 'SelectCategory':
				var filters_ = _elm_lang$core$Native_Utils.update(
			...
			case 'UpdateSearch':
				...
				var search_ = function () {
					var _p6 = _elm_lang$core$String$isEmpty(_p7);
					if (_p6 === false) {
				...
				return A2(
					...
					{ctor: '[]'});
			default:
				var record = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (r) {
							return _elm_lang$core$Native_Utils.eq(r.id, _p2._0);
						},
						_p9.allRecords));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$model = {
	allRecords: {ctor: '[]'},
	displayRecords: {ctor: '[]'},
	currentRecord: _elm_lang$core$Maybe$Nothing,
	filters: {limitChapter: 1, maxChapter: 1, category: _user$project$Savage_Data$Character, text: _elm_lang$core$Maybe$Nothing}
};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {allRecords: a, displayRecords: b, currentRecord: c, filters: d};
	});
var _user$project$Main$Filters = F4(
	function (a, b, c, d) {
		return {limitChapter: a, maxChapter: b, category: c, text: d};
	});
var _user$project$Main$SelectRecord = function (a) {
	return {ctor: 'SelectRecord', _0: a};
};
var _user$project$Main$UpdateSearch = function (a) {
	return {ctor: 'UpdateSearch', _0: a};
};
var _user$project$Main$SelectCategory = function (a) {
	return {ctor: 'SelectCategory', _0: a};
};
var _user$project$Main$UpdateChapter = function (a) {
	return {ctor: 'UpdateChapter', _0: a};
};
var _user$project$Main$FetchDataCompleted = function (a) {
	return {ctor: 'FetchDataCompleted', _0: a};
};
var _user$project$Main$fetchDataCmd = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$FetchDataCompleted,
	A2(_elm_lang$http$Http$get, 'data.json', _user$project$Savage_Data$dataDecoder));
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Main$model,
	{
		ctor: '::',
		_0: _user$project$Main$fetchDataCmd,
		_1: {ctor: '[]'}
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$ChapterNumber = {ctor: 'ChapterNumber'};
var _user$project$Main$ContentItem = {ctor: 'ContentItem'};
var _user$project$Main$ContentList = {ctor: 'ContentList'};
var _user$project$Main$ContentSummary = {ctor: 'ContentSummary'};
var _user$project$Main$ContentContainer = {ctor: 'ContentContainer'};
var _user$project$Main$SideItem = {ctor: 'SideItem'};
var _user$project$Main$SideList = {ctor: 'SideList'};
var _user$project$Main$CategorySelect = {ctor: 'CategorySelect'};
var _user$project$Main$SideContainer = {ctor: 'SideContainer'};
var _user$project$Main$Header = {ctor: 'Header'};
var _user$project$Main$Page = {ctor: 'Page'};
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$pageFilters = function (filters) {
	return A3(
		_mdgriffith$style_elements$Element$row,
		...
		},
		{
			...
			_0: A3(
				...
				{
					onChange: _user$project$Main$UpdateChapter,
					value: _elm_lang$core$Basics$toString(filters.limitChapter),
					label: _mdgriffith$style_elements$Element_Input$hiddenLabel('page slider'),
					options: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(
					...
					},
					{
						onChange: _user$project$Main$UpdateChapter,
						value: _elm_lang$core$Basics$toString(filters.limitChapter),
						label: _mdgriffith$style_elements$Element_Input$hiddenLabel('page input'),
						options: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$searchFilter = function (filters) {
	return A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$Main$None,
		{
		...
		},
		{
			...
			_0: A3(
				...
				{
					onChange: _user$project$Main$UpdateSearch,
					value: A2(_elm_lang$core$Maybe$withDefault, '', filters.text),
					label: _mdgriffith$style_elements$Element_Input$placeholder(
						{
							text: 'Search',
							label: _mdgriffith$style_elements$Element_Input$hiddenLabel('search')
						}),
					options: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$content = function (model) {
	var contentItem = function (i) {
		return A3(
			_mdgriffith$style_elements$Element$row,
			_user$project$Main$ContentItem,
			{
				ctor: '::',
				_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 20, 5),
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$spacing(10),
					_1: {
			...
			},
			{
				...
				_0: A3(
					...
					_user$project$Main$ChapterNumber,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$width(
							_mdgriffith$style_elements$Element_Attributes$px(60)),
						_1: {
							ctor: '::',
					...
					_mdgriffith$style_elements$Element$text(
						_elm_lang$core$Basics$toString(i.chapter))),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$el,
						_user$project$Main$None,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text(i.text)),
					_1: {ctor: '[]'}
				}
			});
	};
	var contentList = function (entries) {
		return A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$Main$ContentList,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, contentItem, entries));
	};
	var displaySummary = function (entries) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'huh?',
			function (_) {
				...
				A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Savage_Data$emptyEntry,
					_elm_lang$core$List$head(
						_elm_lang$core$List$reverse(
							A2(
								_elm_lang$core$List$filter,
								function (e) {
									return _elm_community$maybe_extra$Maybe_Extra$isJust(e.summary);
								},
								entries))))));
	};
	var displayEntries = function (record) {
		return A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (e) {
					return _elm_lang$core$Native_Utils.cmp(e.chapter, model.filters.limitChapter) < 1;
				},
				record.entries));
	};
	var record_ = A2(_elm_lang$core$Maybe$withDefault, _user$project$Savage_Data$emptyRecord, model.currentRecord);
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Main$ContentContainer,
		{
			ctor: '::',
			_0: _mdgriffith$style_elements$Element_Attributes$width(_mdgriffith$style_elements$Element_Attributes$fill),
			_1: {
		...
		},
		{
			...
			_0: A3(
				...
				_mdgriffith$style_elements$Element$text(record_.title)),
			_1: {
				ctor: '::',
				_0: A3(
					_mdgriffith$style_elements$Element$el,
					_user$project$Main$ContentSummary,
					{
						ctor: '::',
						_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 20, 10),
						_1: {ctor: '[]'}
...
var _user$project$Main$Selected = {ctor: 'Selected'};
					...
					_1: {
						...
						_1: {
							...
							_0: _mdgriffith$style_elements$Style_Font$typeface(
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$font('Open Sans'),
									_1: {
										ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					_user$project$Main$Header,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Color$background(
							A3(_elm_lang$core$Color$rgb, 24, 24, 72)),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Font$typeface(
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$font('Shadows Into Light'),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Font$font('cursive'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
				...
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_user$project$Main$SideContainer,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Color$background(
								A3(_elm_lang$core$Color$rgb, 120, 144, 168)),
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
								_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$Main$CategorySelect,
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Border$none,
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Color$background(
									...
									_1: {
										...
										_0: A2(
											...
											_user$project$Main$Selected,
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Color$background(
													A3(_elm_lang$core$Color$rgb, 240, 168, 24)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
						...
						_1: {
							...
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_user$project$Main$SideList,
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: A2(
									_mdgriffith$style_elements$Style$style,
									_user$project$Main$SideItem,
									{
										ctor: '::',
										_0: A2(
											_mdgriffith$style_elements$Style$variation,
								...
								_1: {
									...
									_0: A2(
										...
										_user$project$Main$ContentContainer,
										{
											ctor: '::',
											_0: _mdgriffith$style_elements$Style_Color$background(
												A3(_elm_lang$core$Color$rgb, 48, 72, 120)),
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
												_1: {ctor: '[]'}
...
var _user$project$Main$categoryFilter = function (filters) {
	return A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$Main$None,
		{
				...
				_user$project$Main$CategorySelect,
				{
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$Main$Selected,
							_elm_lang$core$Native_Utils.eq(filters.category, _user$project$Savage_Data$Character)),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Events$onClick(
								_user$project$Main$SelectCategory(_user$project$Savage_Data$Character)),
							_1: {ctor: '[]'}
						}
					}
				},
				_mdgriffith$style_elements$Element$text('Characters')),
			_1: {
				ctor: '::',
				_0: A3(
					_mdgriffith$style_elements$Element$button,
					_user$project$Main$CategorySelect,
					{
						...
						_1: {
							...
							_0: A2(
								_mdgriffith$style_elements$Element_Attributes$vary,
								_user$project$Main$Selected,
								_elm_lang$core$Native_Utils.eq(filters.category, _user$project$Savage_Data$Power)),
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Events$onClick(
									_user$project$Main$SelectCategory(_user$project$Savage_Data$Power)),
								_1: {ctor: '[]'}
							}
						}
					},
					_mdgriffith$style_elements$Element$text('Powers')),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$button,
						_user$project$Main$CategorySelect,
						{
							...
							_1: {
								...
								_0: A2(
									_mdgriffith$style_elements$Element_Attributes$vary,
									_user$project$Main$Selected,
									_elm_lang$core$Native_Utils.eq(filters.category, _user$project$Savage_Data$World)),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Events$onClick(
										_user$project$Main$SelectCategory(_user$project$Savage_Data$World)),
									_1: {ctor: '[]'}
								}
							}
						},
						_mdgriffith$style_elements$Element$text('World')),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$itemList = F2(
				...
				_user$project$Main$SideItem,
				{
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Element_Attributes$vary,
							_user$project$Main$Selected,
							_elm_lang$core$Native_Utils.eq(r.id, currentID)),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Events$onClick(
								_user$project$Main$SelectRecord(r.id)),
							_1: {ctor: '[]'}
						}
					}
				},
				_mdgriffith$style_elements$Element$text(r.title));
		};
		return A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$Main$SideList,
			...
			A2(_elm_lang$core$List$map, record, records));
	});
var _user$project$Main$side = function (model) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Main$SideContainer,
		{
		...
		},
		{
			...
			_0: A3(
				...
				_mdgriffith$style_elements$Element$text('the Savage Codex')),
			_1: {
				ctor: '::',
				_0: _user$project$Main$pageFilters(model.filters),
				_1: {
					ctor: '::',
					_0: _user$project$Main$categoryFilter(model.filters),
					_1: {
						ctor: '::',
						_0: _user$project$Main$searchFilter(model.filters),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$itemList, model.displayRecords, model.currentRecord),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$Main$side(model),
				_1: {
					ctor: '::',
